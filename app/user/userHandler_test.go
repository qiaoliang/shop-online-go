...
func (st *UserHandlerSuite) Test_Register_User() {
	...
	exp := `{"code":0,"data":{"token":"newUser","base":{"id":"userIdt4qrttebiw","pwd":"天下无贼","mobile":"newUser","nick":"secret","avatarUrl":"http://localhost:9090/pic/avatar/k.jpeg","province":"未知","city":"未知","autoLogin":0,"userInfo":"FakeUserInfo","userLevel":{"id":1,"name":"Green"}},"userLevel":{"id":1,"name":"Green"}},"msg":"OK"}`
