...
func (gr *GoodsRepo) loadGoods() []GoodsItem {
	...
	picA := Picture{"g7227946-01", configs.Cfg.GoodsPicPrefix() + "g7227946-01.jpeg"}
	picB := Picture{"g7227946-02", configs.Cfg.GoodsPicPrefix() + "g7227946-02.jpeg"}
	pics := make([]Picture, 0)
	...
	items2 := &GoodsItem{
		...
		0,          //catalogueId
		"2",        //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g7225947.jpeg", //picURL
		"77.0",  //MinPrice
		"109.0", //originalPrice
		GoodsDetail{},
	}
	items3 := &GoodsItem{
		...
		0,             //catalogueId
		"3",           //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g7225948.jpeg", //picURL
		"60.0", //MinPrice
		"89.0", //originalPrice
		GoodsDetail{},
	}
	items4 := &GoodsItem{
		...
		0,        //catalogueId
		"4",      //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g7225949.jpeg", //picURL
		"80.0",  //MinPrice
		"129.0", //originalPrice
		GoodsDetail{},
	}
	...
	items5 := &GoodsItem{
		...
		1,       //catalogueId
		"1",     //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g1872110.jpeg", //picURL
		"50.0", //MinPrice
		"75.0", //originalPrice
		GoodsDetail{},
	}
	items6 := &GoodsItem{
		...
		1,        //catalogueId
		"2",      //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g1872111.jpeg", //picURL
		"41.0", //MinPrice
		"65.0", //originalPrice
		GoodsDetail{},
	}
	items7 := &GoodsItem{
		...
		1,            //catalogueId
		"3",          //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g1872112.jpeg", //picURL
		"60.0", //MinPrice
		"89.0", //originalPrice
		GoodsDetail{},
	}
	items8 := &GoodsItem{
		...
		1,   //catalogueId
		"4", //recommandStatus
		configs.Cfg.GoodsPicPrefix() + "g1872113.jpeg", //picURL
		"80.0",  //MinPrice
		"129.0", //originalPrice
		GoodsDetail{},
	}
