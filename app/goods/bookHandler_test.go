...
func (st *BookHandlerSuite) Should_Delete_book_when_Book_existed() {
	//构建参数
	...
	exp := `{"data":[{"id":2,"title":"Les Trois Mousquetaires","author":"Alexandre Dumas fils"},{"id":3,"title":"Continuous Delivery","author":"Jez"},{"id":4,"title":"haha","author":"wowowo"}]}`
	st.Equal(exp, string(body), "should same.")
}
