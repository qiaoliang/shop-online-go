...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_afocus_captcha",
        importpath = "github.com/afocus/captcha",
        sum = "h1:uFrPOl1VBt/Abfl2z+A/DFc+AwmFLxEHR1+Yq6cXvww=",
        version = "v0.0.0-20191010092841-4bd1f21c8868",
    )
    go_repository(
