...
( "g1872110","驾驭大数据", 1, "1", "g1872110.jpeg", "册", 5, "99.0", "129.0", "1", "《驾驭大数据》是一本大数据的入门级好书。", 0, 1),
( "g1872111","数据分析变革", 1, "1", "g1872111.jpeg", "册", 15, "66.0", "99.0", "1", "《数据分析变革》是一本讲解如何通过数据分析指引业务增长与创新的书。", 0, 1),
( "g1872112","大数据测试技术与实践", 1, "1", "g1872112.jpeg", "册", 25,  "55.0", "85.0", "1", "《大数据测试技术与实践》是一本讲如何进行大数据系统测试与工具方法论的书。", 0, 1),
( "g1872113","图解Spark 大数据快速分析实战", 1, "1", "g1872113.jpeg", "册", 35,  "77.0", "107.0", "1", "《图解Spark 》是一本如何使用Spark进行大数据处理的书。", 0, 1);